...
# fail("This is a fail with the ${neutron_db_password} on this password for the neutron db")

# Added IB
  nova_config {
    'keystone_authtoken/auth_uri':          value => 'http://keystpri100:5000';
    'keystone_authtoken/auth_host':         value => 'keystadmi100';
    ...
    'keystone_authtoken/admin_tenant_name': value => 'service';
    'keystone_authtoken/admin_password':    value => $neutron_user_password;
  }
  package { 'python-import-utils':
      ensure => 'present',
  }
...
# Added IB
# Add nova_admin_tenant_name => "service",
