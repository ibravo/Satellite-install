...
hammer -u admin -p changeme content-view add-repository --id 4 --organization Test_Cloud7 --repository-id 3
...
hammer -u admin -p changeme content-view add-repository --id 5 --organization Test_Cloud7 --repository-id 4
...
hammer -u admin -p changeme content-view add-repository --id 6 --organization Test_Cloud7 --repository-id 5
...
hammer -u admin -p changeme content-view add-repository --id 7 --organization Test_Cloud7 --repository-id 6
...
#----------------|---------------------------|--------------------------------------|-----------|---------------
#2               | Default Organization View | 08ea93a9-f36c-43f6-8ea4-421e52f7db08 |           |               
#3               | Puppet                    | Puppet                               |           |               
#4               | CentOS Base               | CentOS_Base                          |           |               
#5               | Foreman                   | Foreman                              |           |               
